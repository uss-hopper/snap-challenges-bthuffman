...
let NumberOfBadOmbres = 0;

function getTheBadOmbres(item) {
	if (item.userId !==5) {
		return true;
	}
	NumberOfBadOmbres++;
...
let arrayFilter = arrayOne.filter(getTheBadOmbres);

console.log('These arrays can stay...', arrayFilter);

console.log('These were the number of objects in the array with the userId of 5', NumberOfBadOmbres);