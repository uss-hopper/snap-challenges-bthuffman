...
var arrByID = arrayOne.filter(filterByID);

console.log('Filtered Array\n', arrByID);
// Filtered Array


console.log('Number of Entries with the userId #5 = ', userIdOfFiveEntries);
// Number of Entries with userId = 5
// Returns 2
...
function logConsole (arrayOne) {
	console.log(arrayOne);
}

logConsole(arrayOne);
const result = arrayOne.filter(callback(index=>[4,5]);
